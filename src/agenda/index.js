...
export default class AgendaView extends Component {
  static propTypes = {
    ...
    reservationsStyle: viewPropTypes.style,
    ...
    // Display calendars. Default = false
    show: PropTypes.bool,
  ...
  chooseDay(d, optimisticScroll) {
    ...
    if (this.props.horizontal) {
      this.calendar.scrollToMonth(day, this.calendarOffset(), true);
    } else {
  ...
  render() {
    ...
    const headerStyle = [
      this.styles.header,
      !this.props.horizontal && { bottom: agendaHeight, transform: [{ translateY: headerTranslate }] },
    ];
    ...
    const scrollPadStyle = {
      ...
      width: 80,
      height: KNOB_HEIGHT,
      top: this.props.horizontal ? 0 : scrollPadPosition,
    ...
    return (
      <View onLayout={this.onLayout} style={[this.props.style, { flex: 1, overflow: 'hidden' }]}>
        <View style={[this.styles.reservations, this.props.show ? this.props.reservationsStyle : null]}>
          {this.renderReservations()}
        </View>
        {
          this.props.show &&
          <Animated.View style={headerStyle}>
            <Animated.View style={[{ flex: 1 }, this.props.horizontal ? null : { transform: [{ translateY: contentTranslate }] }]}>
              <CalendarList
                onLayout={() => {
                  this.props.horizontal ? null : this.calendar.scrollToDay(this.state.selectedDay.clone(), this.calendarOffset(), false);
              }}
                horizontal={this.props.horizontal}
                calendarHeight={this.props.horizontal ? 320 : this.props.calendarHeight}
                ...
                scrollingEnabled={this.props.horizontal ? true : this.state.calendarScrollable}
