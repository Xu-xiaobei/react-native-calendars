...
class CalendarList extends Component {
  ...
  renderCalendar({ item }) {
    return (<CalendarListItem item={item} calendarHeight={this.props.calendarHeight} calendarWidth={this.props.horizontal ? this.props.calendarWidth : undefined} {...this.props} horizontal={this.props.horizontal} />);
  }
